...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "EOL", "$accept", "S", "expr", YY_NULLPTR
};
...
#line 1135 "y.tab.c"
  ...
  case 4: /* expr: expr expr PLUS  */
#line 22 "lab7.y"
                        { int b = pop(); int a = pop(); push(a + b); }
#line 1141 "y.tab.c"
    break;

  case 5: /* expr: expr expr MINUS  */
#line 23 "lab7.y"
                        { int b = pop(); int a = pop(); push(a - b); }
#line 1147 "y.tab.c"
    break;

  case 6: /* expr: expr expr MULTIPLY  */
#line 24 "lab7.y"
                         { int b = pop(); int a = pop(); push(a * b); }
#line 1153 "y.tab.c"
    break;

  case 7: /* expr: expr expr DIVIDE  */
#line 25 "lab7.y"
                        { int b = pop(); int a = pop(); push(a / b); }
#line 1159 "y.tab.c"
    break;
